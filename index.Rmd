...
Questa è la pagina web dell'insegnamento *Costruzione e validazione di strumenti di misura dell'efficacia dell'intervento psicologico in neuropsicologia*, prof. [Corrado Caudek](https://ccaudek.github.io/caudeklab/), Corso di Laurea Magistrale in Psicologia Clinica e della Salute e Neuropsicologia (curriculum: assessment e intervento psicologico in neuropsicologia - E21), [Università degli Studi di Firenze](https://www.unifi.it), anno accademico 2021-2022.

_Questa pagina web verrà periodicamente aggiornata durante il periodo di svolgimento dell'insegnamento (marzo-maggio 2022)._

## Descrizione sintetica 

L'insegnamento *Costruzione e validazione di strumenti di misura dell'efficacia dell'intervento psicologico in neuropsicologia* ha lo scopo di fornire agli studenti le conoscenze di base di statistica, di analisi dei dati e di metodologia della ricerca che costituiscono uno degli aspetti centrali del bagaglio professionale dello psicologo. Il presente insegnamento non si limiterà ad una descrizione astratta degli argomenti trattati, anche perché tali concetti risultano poco comprensibili se non vengono utilizzati nell'ambito di applicazioni concrete. Gli argomenti del corso verranno invece accompagnati da esercitazioni pratiche e laboratori didattici. Per tali analisi guidate dei dati sarà necessario utilizzare un computer e un linguaggio di programmazione per l'analisi statistica dei dati. Poiché la psicometria e la statistica moderne possono essere eseguite utilizzando software open source come $\textsf{R}$, gli esempi saranno presentati in $\textsf{R}$. 
